...
const Video = forwardRef<HTMLDivElement, { coverUrl: string; url: string }>(({ coverUrl, url }, ref) => {
    ...
    return (
        <div ref={ref} className="absolute inset-0">
            ...
            <Transition show={open} className="fixed inset-0 bg-background transition-opacity" enter="transition ease-out duration-200" enterFrom="opacity-0" enterTo="opacity-100" leave="transition ease-out duration-100" leaveFrom="opacity-100" leaveTo="opacity-0" />
