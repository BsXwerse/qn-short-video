            ...
            <div className="flex flex-col gap-4 py-10 px-8">
                <Link href='/' >
                    <div className=" flex items-center justify-center mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-api-app hover:bg-foreground/10 rounded-full transition-colors duration-150" width="40" height="40" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
