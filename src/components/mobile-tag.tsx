    ...
    return (
        <Popover>
            ...
            <Transition
                ...
                leaveTo="opacity-0"
            >
                <Popover.Panel className='z-10 bg-background/90 border-foreground/50 border-[1px] rounded m-2 backdrop-blur flex flex-col  justify-center text-base p-2 overflow-auto max-h-72 gap-2'
